...
export function Dialog({ kind, project, projects, currentCase, assemblies, providerProfiles, providerProfileId, onClose, onCreateSession, onCreateProvider, onCreateCase, onCreateProject, onSelectProject, onProviderProfile }: { readonly kind: DialogKind; readonly project: ProjectFixture; readonly projects: readonly ProjectFixture[]; readonly currentCase: StudioCase; readonly assemblies: readonly StudioAssembly[]; readonly providerProfiles: readonly ProviderProfileSummary[]; readonly providerProfileId: string; readonly onClose: () => void; readonly onCreateSession: (title: string, cwd: string, providerProfileId: string, reasoningEffort: ReasoningEffort | undefined, approvalMode: ApprovalMode, assemblyId: string) => void; readonly onCreateProvider: (input: ProviderProfileDraft) => void; readonly onCreateCase: (title: string, assemblyId: string) => void; readonly onCreateProject: (name: string, root: string) => void; readonly onSelectProject: (id: string) => void; readonly onProviderProfile: (providerProfileId: string) => void }) {
  const { t } = useI18n()
  ...
  const [assemblyId, setAssemblyId] = useState(currentCase.assemblyId)
