...
import type { ApprovalMode, ProviderProfileDraft, ProviderProfileSummary, ReasoningEffort, SessionSummary, StudioCase } from '../api/workbench-api'
...
export function Dialog({ kind, project, projects, currentCase, providerProfiles, providerProfileId, onClose, onCreateSession, onCreateProvider, onCreateCase, onCreateProject, onSelectProject, onProviderProfile }: { readonly kind: DialogKind; readonly project: ProjectFixture; readonly projects: readonly ProjectFixture[]; readonly currentCase: StudioCase; readonly providerProfiles: readonly ProviderProfileSummary[]; readonly providerProfileId: string; readonly onClose: () => void; readonly onCreateSession: (title: string, cwd: string, providerProfileId: string, reasoningEffort: ReasoningEffort | undefined, approvalMode: ApprovalMode) => void; readonly onCreateProvider: (input: ProviderProfileDraft) => void; readonly onCreateCase: (title: string) => void; readonly onCreateProject: (name: string, root: string) => void; readonly onSelectProject: (id: string) => void; readonly onProviderProfile: (providerProfileId: string) => void }) {
  const { t } = useI18n()
