...
import type { ApprovalMode, ProviderProfileSummary, ReasoningEffort, SessionSummary, StudioAssembly, StudioCase } from '../api/workbench-api'
...
export function Dialog({ kind, project, projects, currentCase, assemblies, providerProfiles, providerProfileId, onClose, onCreateSession, onCreateCase, onCreateProject, onSelectProject, onProviderProfile }: { readonly kind: DialogKind; readonly project: ProjectView; readonly projects: readonly ProjectView[]; readonly currentCase: StudioCase; readonly assemblies: readonly StudioAssembly[]; readonly providerProfiles: readonly ProviderProfileSummary[]; readonly providerProfileId: string; readonly onClose: () => void; readonly onCreateSession: (title: string, cwd: string, providerProfileId: string, reasoningEffort: ReasoningEffort | undefined, approvalMode: ApprovalMode, projectId: string) => void; readonly onCreateCase: (title: string, projectId: string) => void; readonly onCreateProject: (name: string, root: string, assemblyId: string) => void; readonly onSelectProject: (id: string) => void; readonly onProviderProfile: (providerProfileId: string) => void }) {
  const { t } = useI18n()
